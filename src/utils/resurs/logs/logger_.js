...
const userLogsPath = path.join(process.cwd(), "src", "utils", "resurs", "Logs","userLogs", "user.logger.log");
const serverLogsPath = path.join(process.cwd(), "src", "utils", "resurs", "Logs","serverLogs", "server.logger.log");
